      ...
      <div class="card-body">
        ...
        {{csrf_field()}} 
          <div class="form-group row mt-2">
            ...
            <div class="col pl-0">
              <input class="form-control border-0" placeholder="Write a caption..." type="text" name="caption" value="{{ old('list_name') }}"/>
            </div>
          </div>
          <div class="mb-3">
...
<script type="text/javascript">
  $('#post_image').bind('change', function() {
    ...
    if (size_in_megabytes > 1) {
      alert('File image is upto 1MB. Choose another one.');
    }
  });
</script>
@endsection